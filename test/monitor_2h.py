...
METRICS_FILE = "/home/amoratran/server/better-tts-ui-studio/test/metrics_2h.json"
HTML_FILE = "/home/amoratran/server/better-tts-ui-studio/test/ram_report_2h.html"
DURATION_SECONDS = 7320  # 122 minutes
INTERVAL_SECONDS = 15
...
<head>
    <meta charset="UTF-8">
    <title>2-Hour Comparison Endurance Report (1k vs 5k VUs)</title>
...
<body>
    <div class="header">
        <h1>📊 2-Hour Comparison Endurance Report (1k VUs vs 5k VUs)</h1>
        <p>Schedule: 15m Initial Rest ➔ Wave 1 (1k VUs) ➔ Wave 2 (5k VUs) ➔ Extended Rest | Map Re-allocation Enabled</p>
    </div>
    ...
    <div class="grid">
        <div class="card">
            <h2>🧠 Container Memory Usage (MiB) Over 2 Hours</h2>
            <div class="chart-container">
                <canvas id="memChart"></canvas>
            </div>
        </div>
        <div class="card">
            <h2>⚡ Backend CPU Load (%) Over 2 Hours</h2>
            <div class="chart-container">
...
def main():
    ...
    print(f"[{datetime.now().strftime('%H:%M:%S')}] Started 2-Hour Comparison Monitoring script...")
