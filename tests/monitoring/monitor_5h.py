...
<head>
    <meta charset="UTF-8">
    <title>5-Hour Endurance Test - Memory & CPU Metrics Report</title>
...
<body>
    <div class="header">
        <h1>🚀 5-Hour Stepped Endurance Test Report</h1>
        <p>Waves: 10 Peak Waves (500 → 5000 VUs) | Sampling Rate: 15s | Status: Live Recording</p>
    </div>
    ...
    <div class="grid">
        <div class="card">
            <h2>🧠 Container Memory Usage (MiB) Over 5 Hours</h2>
            <div class="chart-container">
                <canvas id="memChart"></canvas>
            </div>
        </div>
        <div class="card">
            <h2>⚡ Backend CPU Load (%) Over 5 Hours</h2>
            <div class="chart-container">
...
def main():
    ...
    print(f"[{datetime.now().strftime('%H:%M:%S')}] Started 5-Hour RAM/CPU Monitoring script...")
