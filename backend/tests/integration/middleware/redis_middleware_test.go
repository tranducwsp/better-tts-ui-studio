...
// TestRedisRateLimit_SharedAcrossReplicas kiểm tra rate limit dùng chung qua Redis.
...
// TestRedisUserCache_SharedAndInvalidated kiểm tra cache dùng chung và xoá đồng bộ qua Redis.
